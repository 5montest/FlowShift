    ...
    <main className="home-grid">
      <section className="home-intro"><div>
        ...
        <div className="home-actions">
          <button type="button" onClick={onConnect} className="secondary-button" disabled={calendar.loading || !calendar.configured}><GoogleG />{calendar.loading ? '接続状態を確認中' : 'Google Calendarを接続'}</button>
        </div>
